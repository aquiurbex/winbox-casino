          ...
          {games.map((game) => (
            <div key={game.id} className="game-card">
              ...
              <div className="mt-auto">
                ...
                <button className="w-full mt-4 py-2 rounded-lg bg-casino-accent hover:bg-neon-green/20 border border-neon-green/20 hover:border-neon-green/40 transition-all duration-300 text-white/80 hover:text-white font-medium">
                  Play Now
                </button>
              </div>
            </div>
